...
object GmpBulkCalculationResponse {
  ...
  def createFromCalculationResponse(calculationResponse: CalculationResponse): GmpBulkCalculationResponse =
  ...
  def createFromHipCalculationResponse(hipResponse: HipCalculationResponse): GmpBulkCalculationResponse = {

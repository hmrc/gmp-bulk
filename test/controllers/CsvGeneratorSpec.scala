...
class CsvGeneratorSpec extends PlaySpec with GuiceOneAppPerSuite with MockitoSugar {
  ...
  val singlePeriodGmpBulkCalculationResponse = GmpBulkCalculationResponse(
    List(CalculationPeriod(Some(LocalDate.now), LocalDate.now, "3.12", "1.23", 0, 0, None, None, None, None, None)),
    0,
    None,
    None,
    None
  ...
  val multiplePeriodGmpBulkCalculationResponse = GmpBulkCalculationResponse(
    List(
  ...
  val calculationResponseWithError = GmpBulkCalculationResponse(
    List(CalculationPeriod(Some(LocalDate.now), LocalDate.now, "3.12", "1.23", 0, 0, None, None, None, None, None)),
    56010,
    None,
    None,
  ...
  val calculationResponseWithNpsError = GmpBulkCalculationResponse(
    List(CalculationPeriod(Some(LocalDate.now), LocalDate.now, "3.12", "1.23", 0, 56018, None, None, None, None, None)),
    0,
    None,
    None,
    None
  ...
  val calculationRequestsSingle    = List(
    ProcessReadyCalculationRequest("1", 1, Some(validCalculationRequest), None, Some(singlePeriodGmpBulkCalculationResponse))
  )

  val calculationRequestsMultiple = List(
    ProcessReadyCalculationRequest("1", 1, Some(validCalculationRequest), None, Some(multiplePeriodGmpBulkCalculationResponse)),
    ProcessReadyCalculationRequest("1", 1, Some(validCalculationRequest), None, Some(singlePeriodGmpBulkCalculationResponse))
  )

  val calculationRequestWithError = List(
    ProcessReadyCalculationRequest("1", 1, Some(validCalculationRequest), None, Some(calculationResponseWithError))
  )
  val calculationRequestWithNpsError = List(
    ProcessReadyCalculationRequest("1", 1, Some(validCalculationRequest), None, Some(calculationResponseWithNpsError))
  )

  val bulkCalculationRequestNoReponse =
    ProcessedBulkCalculationRequest("1", "abcd", "mail@mail.com", "reference1", calculationRequestNoResponse, "userId", LocalDateTime.now, true, 1, 0)
  val bulkCalculationRequestSingle =
    ProcessedBulkCalculationRequest("1", "abcd", "mail@mail.com", "reference1", calculationRequestsSingle, "userId", LocalDateTime.now, true, 1, 0)
  val bulkCalculationRequestMultiple =
    ProcessedBulkCalculationRequest("1", "abcd", "mail@mail.com", "reference1", calculationRequestsMultiple, "userId", LocalDateTime.now, true, 1, 0)
  val bulkCalculationRequestWithError =
    ProcessedBulkCalculationRequest("1", "abcd", "mail@mail.com", "reference1", calculationRequestWithError, "userId", LocalDateTime.now, true, 1, 0)
  val bulkCalculationRequestWithNpsError = ProcessedBulkCalculationRequest(
    "1",
    "abcd",
    "mail@mail.com",
    "reference1",
    calculationRequestWithNpsError,
    "userId",
    LocalDateTime.now,
    true,
    1,
  ...
  "CsvGenerator" must {
    ...
    "return bulk result as a csv string" in {
      ...
      val periodColumns =
        "gmp.period 1 gmp.period.start_date,gmp.period 1 gmp.period.end_date,gmp.period 1 gmp.period.total,gmp.period 1 gmp.period.post_88,gmp.period 1 gmp.period.post_90_true,gmp.period 1 gmp.period.post_90_opp,gmp.period 1 gmp.period.reval_rate,gmp.period 1 gmp.period.error,gmp.period 1 gmp.period.what,gmp.bulk.csv.globalerror.headers"
    ...
    "getCalculationsAsCsv when revaluation with different rates" must {
      ...
      "return bulk result as a csv string" in {
        val periodColumns =
          "gmp.period 1 gmp.period.start_date,gmp.period 1 gmp.period.end_date,gmp.period 1 gmp.period.total,gmp.period 1 gmp.period.post_88,gmp.period 1 gmp.period.post_90_true,gmp.period 1 gmp.period.post_90_opp,gmp.period 1 gmp.period.reval_rate,gmp.period 1 gmp.period.error,gmp.period 1 gmp.period.what,gmp.period 2 gmp.period.start_date,gmp.period 2 gmp.period.end_date,gmp.period 2 gmp.period.total,gmp.period 2 gmp.period.post_88,gmp.period 2 gmp.period.post_90_true,gmp.period 2 gmp.period.post_90_opp,gmp.period 2 gmp.period.reval_rate,gmp.period 2 gmp.period.error,gmp.period 2 gmp.period.what,gmp.period 3 gmp.period.start_date,gmp.period 3 gmp.period.end_date,gmp.period 3 gmp.period.total,gmp.period 3 gmp.period.post_88,gmp.period 3 gmp.period.post_90_true,gmp.period 3 gmp.period.post_90_opp,gmp.period 3 gmp.period.reval_rate,gmp.period 3 gmp.period.error,gmp.period 3 gmp.period.what"

        val csvRows =
          """gmp.success,S2730000B,BH000007A,John,Smith,ref1,gmp.calc_type.specific_date,,21/08/2035,HMRC,gmp.generic.no,12.48,4.92,,,21/08/2040,21/08/2035,3.12,1.23,,,s148,,,21/08/2000,21/08/2005,3.12,1.23,,,Fixed,,,21/08/1999,21/08/2000,3.12,1.23,,,Limited,,,21/08/1999,21/08/2000,3.12,1.23,,,s148,,,,"""
        val guidanceText  = s"${Messages("gmp.bulk.csv.guidance")},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,"
    ...
    "set the correct calculation type" in {
      ...
      val calculationRequests = List(
        ProcessReadyCalculationRequest("1", 1, Some(validCalculationRequest.copy(calctype = Some(1))), None, Some(gmpBulkCalculationResponse)),
    ...
    "return no period headers when no periods exist in response" in {
      ...
      val calculationRequests =
        List(ProcessReadyCalculationRequest("1", 1, Some(validCalculationRequest.copy(calctype = Some(1))), None, Some(gmpBulkCalculationResponse)))
      val bulkCalculationRequest =
        ProcessedBulkCalculationRequest("1", "abcd", "mail@mail.com", "reference1", calculationRequests, "userId", LocalDateTime.now, true, 1, 0)
    ...
    "includes the error message" in {
      ...
      val gmpBulkCalculationResponse = GmpBulkCalculationResponse(List.empty, 0, None, None, None)
      val validCalculationRequest    =
        ValidCalculationRequest("S2730000B", nino, "Smith", "John", Some("ref1"), Some(0), Some("2010-01-31"), None, None, Some("2010-01-31"))
      ...
      val calculationRequests = List(
        ...
        ProcessReadyCalculationRequest(
          "1",
          1,
          Some(validCalculationRequest),
          Some(Map(RequestFieldKey.SCON.toString -> "This row has an error")),
          None
        )
      )
    ...
    "include period data" in {
      ...
      val gmpBulkCalculationResponse = GmpBulkCalculationResponse(
        List(
          CalculationPeriod(Some(LocalDate.now), LocalDate.now, "3.12", "1.23", 0, 0, None, None, None, None, None),
          CalculationPeriod(Some(LocalDate.now), LocalDate.now, "4.12", "5.23", 0, 0, None, None, None, None, None)
        ),
        0,
        None,
        None,
    ...
    "include period data with a dual calc" in {
      ...
      val gmpBulkCalculationResponse = GmpBulkCalculationResponse(
        List(
          ...
          CalculationPeriod(Some(LocalDate.now), LocalDate.now, "4.12", "5.23", 0, 0, None, Some("1.45"), Some("8.90"), None, None)
        ),
        0,
        None,
        None,
    ...
    "include period data with no start date" in {
      ...
      val gmpBulkCalculationResponse = GmpBulkCalculationResponse(
        List(CalculationPeriod(None, LocalDate.now, "3.12", "1.23", 0, 0, None, None, None, None, None)),
        0,
        None,
        None,
        None
    ...
    "report a failed calculation if there is a period error" in {
      ...
      val gmpBulkCalculationResponse = GmpBulkCalculationResponse(
        List(
          CalculationPeriod(Some(LocalDate.now), LocalDate.now, "3.12", "1.23", 0, 0, None, None, None, None, None),
          CalculationPeriod(Some(LocalDate.now), LocalDate.now, "4.12", "5.23", 0, 2, None, None, None, None, None)
        ),
        0,
        None,
        None,
    ...
    "only include successful calculations when requested" in {
      ...
      val periodsResponse = GmpBulkCalculationResponse(
        List(
          CalculationPeriod(Some(LocalDate.now), LocalDate.now, "3.12", "1.23", 0, 0, None, None, None, None, None),
          CalculationPeriod(Some(LocalDate.now), LocalDate.now, "4.12", "5.23", 0, 56002, None, None, None, None, None)
        ),
        0,
        None,
        None,
    ...
    "only include failed calculations when requested" in {
      ...
      val partiallyFailedResponse = GmpBulkCalculationResponse(
        List(
          CalculationPeriod(Some(LocalDate.now), LocalDate.now, "3.12", "1.23", 0, 0, None, None, None, None, None),
          CalculationPeriod(Some(LocalDate.now), LocalDate.now, "4.12", "5.23", 0, 56002, None, None, None, None, None)
        ),
      ...
      val calculationRequests = List(
        ...
        ProcessReadyCalculationRequest(
          ...
          Some(
            Map(
              RequestFieldKey.SCON.toString             -> "This scon has an error",
              ...
              RequestFieldKey.OPPOSITE_GENDER.toString  -> "This dual_calc has an error"
            )
          ),
          None
        )
    ...
    "contain the field validation errors when present" in {
      ...
      val calculationRequests     = List(
        ProcessReadyCalculationRequest(
          ...
          1,
          Some(validCalculationRequest),
          Some(Map(RequestFieldKey.SURNAME.toString -> "Please enter a valid surname")),
          None
        )
      )
      val bulkCalculationRequest =
    ...
    "insert an empty reval rate when member in scheme, and calc type is Survivor" in {
      ...
      val response = GmpBulkCalculationResponse(
        List(CalculationPeriod(Some(LocalDate.now), LocalDate.of(2016, 1, 1), "4.12", "5.23", 1, 0, None, None, None, None, None)),
        0,
        None,
        None,
        None
      ...
      val validCalc =
        ValidCalculationRequest("S2730000B", nino, "Smith", "John", Some("ref1"), Some(3), None, None, None, Some("2016-05-24"), Some(true))
    ...
    "insert an empty reval rate when member in scheme, and calc type is SPA" in {
      ...
      val validCalc =
        ValidCalculationRequest("S2730000B", nino, "Smith", "John", Some("ref1"), Some(4), None, None, None, Some("2016-05-24"), Some(true))
    ...
    "insert an empty reval rate when member in scheme, and calc type is PA" in {
      ...
      val validCalc =
        ValidCalculationRequest("S2730000B", nino, "Smith", "John", Some("ref1"), Some(2), None, None, None, Some("2016-05-24"), Some(true))
    ...
    "insert an empty reval rate into the period when the rate is HMRC" in {
      ...
      val response = GmpBulkCalculationResponse(
        List(CalculationPeriod(Some(LocalDate.now), LocalDate.of(2016, 1, 1), "0", "0", 0, 2, None, None, None, None, None)),
        0,
        None,
        None,
        None
    ...
    "return correct number of trailing commas for multiple period line when successful calculations requested" in {
      ...
      val expectedResult =
        s"S2730000B,$nino,John,Smith,ref1,gmp.calc_type.leaving,,$date,,gmp.generic.no,9.36,3.69,,,$date,$date,3.12,1.23,,,,$date,$date,3.12,1.23,,,,$date,$date,3.12,1.23,,," +
    ...
    "return correct number of trailing commas for multiple period line when all calculations requested" in {
      ...
      val expectedResult =
        s"gmp.success,S2730000B,$nino,John,Smith,ref1,gmp.calc_type.leaving,,$date,,gmp.generic.no,9.36,3.69,,,$date,$date,3.12,1.23,,,,,,$date,$date,3.12,1.23,,,,,,$date,$date,3.12,1.23,,,,,,," +
          "\n" + s"gmp.success,S2730000B,$nino,John,Smith,ref1,gmp.calc_type.leaving,,$date,,gmp.generic.no,3.12,1.23,,,$date,$date,3.12,1.23,,,,,,,,,,,,"
    ...
    "add 8 commas when calculation error exists" in {
      ...
      val expectedResult =
        s"gmp.error,S2730000B,$nino,John,Smith,ref1,gmp.calc_type.leaving,,$date,,gmp.generic.no,3.12,1.23,,,$date,$date,3.12,1.23,,,,,,56010.reason,56010.what"
    ...
    "add 6 commas when nps error exists" in {
      ...
      val expectedResult =
        s"gmp.error,S2730000B,$nino,John,Smith,ref1,gmp.calc_type.leaving,,$date,,gmp.generic.no,3.12,1.23,,,$date,$date,3.12,1.23,,,,56018.reason,56018.what,,"
    ...
    "show no reval rate for calctype 1 and member still in scheme" in {
      ...
      val calcResponse = GmpBulkCalculationResponse(
        List(
          CalculationPeriod(Some(LocalDate.of(1983, 3, 7)), LocalDate.now, "3.12", "1.23", 1, 0, Some(1), Some("0.00"), Some("0.00"), Some(0), None)
        ),
        0,
        None,
        None,
    ...
    "not show reval rate for calctype 1 and member not still in scheme and period closed" in {
      ...
      val calcResponse = GmpBulkCalculationResponse(
        List(
          CalculationPeriod(Some(LocalDate.of(1983, 3, 7)), yesterdaysDate, "3.12", "1.23", 1, 0, Some(1), Some("0.00"), Some("0.00"), Some(0), None)
        ),
        0,
        None,
        None,
    ...
    "not show reval rate for calctype 1 and SM, where DOL and reval date dates exist in the same tax year, reval date after current date" in {
      ...
      val validCalcRequest = ValidCalculationRequest(
        ...
        Some("ref1"),
        Some(1),
        Some(LocalDate.of(2017, 1, 1).toString),
        None,
        Some(0),
        Some(LocalDate.of(2017, 3, 3).toString()),
        Some(false)
      )
      val calcResponse = GmpBulkCalculationResponse(
        List(
    ...
    "not calculate revalution rate where DOL and reval dates exist in the same tax year, rval date before current date" in {
      ...
      val validCalcRequest = ValidCalculationRequest(
        ...
        Some("E2E06"),
        Some(1),
        Some(LocalDate.of(2017, 1, 3).toString),
        None,
        Some(1),
        Some(LocalDate.of(2016, 10, 12).toString),
        Some(false)
      )
      val calcResponse = GmpBulkCalculationResponse(
        List(
